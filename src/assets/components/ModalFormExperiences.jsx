                ...
                <Form onSubmit={handleSubmit}>
                    <Modal.Body>
                        <Form.Group className="mb-3" controlId="formRuolo">
                            ...
                            <Form.Control type="text" placeholder="Es. Sviluppatore Frontend" required name='role' />
                        </Form.Group>

                        <Form.Group className="mb-3" controlId="formCompagnia">
                            <Form.Label>Compagnia</Form.Label>
                            <Form.Control type="text" placeholder="Es. OpenAI" required name='company' />
                        </Form.Group>
                        ...
                        <Form.Group className="mb-3" controlId="formDescrizione">
                            ...
                            <Form.Control as="textarea" rows={3} placeholder="Descrivi la tua esperienza" name='description' />
                        </Form.Group>

                        <Form.Group className="mb-3" controlId="formLuogo">
                            <Form.Label>Luogo</Form.Label>
                            <Form.Control type="text" placeholder="Es. Milano, Italia" name='area' />
                        </Form.Group>
                    </Modal.Body>
