const ExperienceItem = ({ role, org, period, place, mode, bullets }) => (
  <div className="d-flex gap-3 py-3 border-bottom">
    <div className="rounded bg-secondary text-white d-flex align-items-center justify-content-center"
         style={{ width: 40, height: 40 }}>{org[0]}</div>
    <div>
      <div className="fw-semibold">{role}</div>
      <div className="small text-muted">{org} · {period}</div>
      <div className="small text-muted">{place} · {mode}</div>
  ...
  return (
    <div className="border-bottom">
      <div className="d-flex justify-content-between align-items-center p-3 border-bottom">
        <span className="fw-semibold">Esperienza</span>
      ...
      <div className="p-0">
        <ExperienceItem
          ...
          mode="Da remoto"
          bullets={[
            "Supporto agli utenti di enti locali per problematiche nell’utilizzo di applicativi.",
            "Stesura di manuali per l’utilizzo di applicativi."
          ]}
        />
        <ExperienceItem
          ...
          mode="In sede"
          bullets={[
            "Protocollo digitale e fisico tramite applicativo Smart*Desktop Finmatica.",
            "Apprendimento del metodo di conservazione documentale."
          ]}
        />
        <ExperienceItem
          role="Assistente archivista"
